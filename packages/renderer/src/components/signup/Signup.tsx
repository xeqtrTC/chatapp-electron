      ...
      <div className="bg-white/20  w-[20rem] p-5 space-y-5">
        ...
        <form onSubmit={singInFunction}>
          <div className="space-y-5">
            <div>
              <input
                ...
                onBlur={onBlurState}
                className={`outline-none py-3 px-5 w-full rounded ${
                  dataFocus.username && !usernameValid
            ...
            <div>
              <input
                ...
                onBlur={onBlurState}
                className={`outline-none py-3 px-5 w-full rounded ${
                  dataFocus.password && !passwordValid
                    ? 'border-2 border-red-600'
                    : 'border-2 border-white'
                }`}
                name="password"
            ...
            <div>
              <input
                ...
                onBlur={onBlurState}
                className={`outline-none py-3 px-5 w-full rounded ${
                  dataFocus.repeatPassword && !repeatPasswordValid
                    ? 'border-2 border-red-600'
                    : 'border-2 border-white'
                }`}
                name="repeatPassword"
          ...
          <div className="py-5">
            <button
              disabled={!canAdd}
              className="bg-red-600 w-full p-3 rounded text-white font-medium hover:bg-red-800 transition-all ease-out duration-200 disabled:bg-black disabled:cursor-not-allowed"
            >
              Login
            </button>
          </div>
