    ...
    <div className="bg-black/60 fixed h-screen w-full flex justify-center items-center">
      <div className="bg-[#262837] p-3  w-[20rem]">
        <div className="flex justify-end ">
          <AiOutlineClose
            className="text-white cursor-pointer hover:scale-110 transition-all duration-200 ease-in-out h-5 w-5"
            onClick={() => setImageUploadState(false)}
          />
        </div>
        <div className="p-7">
                ...
                <img
                  src={
                    auth?.currentUser?.photoURL
                      ? auth?.currentUser?.photoURL
                      : 'https://www.pngkey.com/png/full/315-3151964_thinking-meme-png-funny-thinking-emoji-png.png'
                  }
          ...
          <div className="py-1">
            ...
            <input
              ...
              type="file"
              className="hidden"
              onChange={uploadImagetest}
            />
          </div>
          <div className="py-5">
            <button
              className="bg-[#1C1F2C] w-full py-1 text-white font-medium rounded-xl"
