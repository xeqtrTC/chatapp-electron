            ...
            <div className=' bg-[#2F3245]  mt-4 rounded-xl py-3 px-5 flex flex-col'>
            {
                searchUserArray.length === 0 ? (
                    ...
                    searchUserArray?.map((item) => {
                        ...
                        return (
                            <div className="py-1" key={uid} onClick={() => onClickSaveUser({ uid, displayName })}>   
    ...
    content = (
        <div className='p-5'>
                <div className='bg-[#2F3245] flex p-4 items-center rounded-xl'>
                        ...
                        <div className='ml-3' onBlur={onBlurGone} >
                            <input type='text' onFocus={() => setSearchFocus(true)} className='bg-transparent outline-none text-[#5C5E6D] font-medium placeholder:text-[#5C5E6D] placeholder:font-medium' placeholder='Search user' onChange={onChangeValue} value={searchUserValue} />
                        </div>
                </div>
            {combinedButtons}
        </div>
