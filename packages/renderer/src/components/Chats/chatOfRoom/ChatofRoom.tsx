    ...
    if (messageSent) {
      try {
        await addDoc(sendMessageCollection, {
          ...
          photoOfSender: auth.currentUser?.photoURL
            ...
            <>
              ...
              >
                <div className="py-5 flex items-center w-full ">
                  <input
                    type="text"
                    className="bg-[#303347] py-3 px-5 w-full text-white rounded-xl outline-none"
                    value={messageSent}
                    onChange={writeMessage}
                    placeholder="Messages..."
                  />
                  <div className="px-3">
                    <button className="bg-[#FB6793] py-2 px-5 rounded-xl text-white">
